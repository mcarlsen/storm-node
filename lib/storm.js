...
Storm.prototype = {
  ...
  emit: function(anchor, tuple, options) {
    ...
    if (anchor && (anchor.id !== undefined && anchor.id !== null) && anchor.tuple instanceof Array) {
      options = options || {};
    ...
    // Bad arity
      ...
      var msg = "Incorrect arguments to `emit`: " + JSON.stringify(arguments);
      this.log(msg);
      throw new Error(msg);
    }
